...
def setup_credentials():
    ...
    try:
        # Essayer d'abord avec le chemin relatif au fichier
        credentials_path = Path(__file__).parent.parent / "mini-projet-459407-943395c7a1f3.json"
        if not credentials_path.exists():
            # Si non trouvé, essayer avec le chemin courant
            credentials_path = os.path.join(os.getcwd(), "mini-projet-459407-943395c7a1f3.json")
...
def get_gcs_file():
    try:
        ...
        credentials_path = r"C:\Users\Martin Anres\OneDrive - ESME\Cours ESME INGE 2\Data tools\mini-projet-459407-5eeaa3b13b0e.json"
